...
- [[https://git.altlinux.org/people/at/packages/?p=sqlite3-pcre.git][sqlite3-pcre]]
- [[https://www.freedesktop.org/wiki/Software/cppunit/][cppunit]] to execute new unit tests
- [[https://fmt.dev/][{fmt}]] library
...
Until pan with sqlite is packaged by Debian, you will have to install
manually the following packages:

#+BEGIN_SRC shell :results verbatim
sudo apt install libsqlitecpp-dev sqlite3-pcre libcppunit-dev liblog4cxx-dev
#+END_SRC
