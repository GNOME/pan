  ...
  static struct log4cxx_initializer
  {
      log4cxx_initializer()
      {
        ...
        if (! g_file_query_exists(file, nullptr))
        {
          ...
          outfile << "log4j.logger.article-cache=WARN, A1" << std::endl;
          outfile << "log4j.logger.article-filter=WARN, A1" << std::endl;
          ...
          outfile << "log4j.logger.header-filter=WARN, A1" << std::endl;
          outfile << "log4j.logger.header-pane=WARN, A1" << std::endl;
          ...
          outfile << "log4j.logger.task=WARN, A1" << std::endl;
