  ...
  static struct log4cxx_initializer
  {
      log4cxx_initializer()
      {
        ...
        if (! g_file_query_exists(file, nullptr))
        {
          ...
          outfile << "log4j.logger.article-tree=DEBUG, A1" << std::endl;
          outfile << "log4j.logger.decoder=DEBUG, A1" << std::endl;
          ...
          outfile << "log4j.logger.task-article=DEBUG, A1" << std::endl;
          outfile << "log4j.logger.task-xover=DEBUG, A1" << std::endl;
