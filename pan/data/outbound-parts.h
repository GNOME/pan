...
#ifndef __Outbound_Parts_h__
#define __Outbound_Parts_h__
...
class OutboundParts
{
  ...
  public:
    class const_iterator
    {
      ...
      public:
        const_iterator(Quark const &q, OutboundParts const &p, int pos = 0) :
          reference_mid(q),
          parts(p),
          n(pos)
        {
  ...
  public:
    ...
    OutboundParts(OutboundParts const &that);
    OutboundParts &operator=(OutboundParts const &);
  ...
  public:
    ...
    bool add_part(number_t num,
                  ...
                  bytes_t bytes,
                  Quark const &reference_mid);
    void set_parts(OutboundPartBatch const &parts);
   ...
   * efficient adding to a OutboundParts object.
   *
   * @see OutboundParts
   * @ingroup data
   */
  ...
  {
    public:
      typedef OutboundParts::number_t number_t;
      typedef OutboundParts::bytes_t bytes_t;

    private:

      friend class OutboundParts;
      struct Part {
        number_t number;
        bytes_t bytes;
        size_t len_used;
    ...
    public:
      ...
      OutboundPartBatch();
      explicit OutboundPartBatch(Quark const &mid, number_t n_parts = 0);
