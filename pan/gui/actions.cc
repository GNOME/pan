...
namespace
{
  ...
  **/
  ...
  GtkToggleActionEntry toggle_entries[] =
  {
    ...
    { "match-only-unread-articles", "ICON_ONLY_NEW", N_("Match Only _Unread Articles"), NULL, N_("Match Only Unread Articles"), G_CALLBACK(do_match_only_unread_articles), false },
