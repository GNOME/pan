...
public:
                     ...
                     int time_posted = 1234)
    {
      ...
      q_subject.bind(1, msg_id);
      q_subject.bind(2, subject);
      res = q_subject.exec();
    ...
    void test_score_article()
    {
      ...
      {
          // todo: modify score_article to return whether the score was changed
        int res =
