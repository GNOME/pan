...
public:
    ...
    {
      pan_db.exec(R"SQL(
        insert into article (message_id,author_id, time_posted, is_read) values ("<m1>", (select id from author where author like "Me%"), 1234, 1);
        insert into article (message_id,author_id, time_posted, is_read) values ("<m2>", (select id from author where author like "Me%"), 1234, 0);
      )SQL");
    ...
    {
      pan_db.exec(R"SQL(
        insert into article (message_id,author_id, time_posted) values ("m1", (select id from author where author like "Me%"), 1234);
        insert into article (message_id,author_id, time_posted) values ("m2", (select id from author where author like "Me%"), 1234);
    ...
    void test_byte_count_ge_or_is_read()
    {
      pan_db.exec(R"SQL(
        insert into article (message_id,author_id, time_posted, is_read) values ("m1", (select id from author where author like "Me%"), 1234,1);
        insert into article (message_id,author_id, time_posted, is_read) values ("m2", (select id from author where author like "Me%"), 1234,0);
        insert into article (message_id,author_id, time_posted, is_read) values ("m3", (select id from author where author like "Me%"), 1234,0);
        insert into article_part (article_id, part_number, part_message_id, size)
           values ((select id from article where message_id == "m1"),1,"m1p1", 1000);
        insert into article_part (article_id, part_number, part_message_id, size)
           values ((select id from article where message_id == "m2"),1,"m2p1", 2000);
    ...
    void test_byte_count_ge_and_is_read()
    {
      pan_db.exec(R"SQL(
        ...
        insert into article (message_id,author_id, time_posted, is_read)
          values ("m2", (select id from author where author like "Me%"), 1234,1);
        insert into article (message_id,author_id, time_posted, is_read)
